...
public class MenuPersistence implements MenuEventReceiver {
    ...
    public void updateMenuItemAdded(Menu m, MenuItem mi) {
        ...
        CookingProcedure.saveMenuProcedure(m.getId(), m.lastCookingProcedureAdded());
    }
    ...
    public void updateItemDeleted(Menu m, Section sec, MenuItem mi) {
        ...
        CookingProcedure cookingProcedure = CookingProcedure.loadProcedureByType(recipe.getId(), "r");
        CookingProcedure.deleteMenuProcedureReference(m.getId(), cookingProcedure.getProcedure_id());
    }
