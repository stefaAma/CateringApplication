...
import businesslogic.recipe.CookingPreparation;
...
public class Menu {
    ...
    private List<CookingProcedure> cookingProcedures = new ArrayList<>();
    ...
    public MenuItem addItem(Recipe recipe, Section sec, String desc) {
        ...
        addCookingProcedure(recipe);
        return mi;
    }

    private void addCookingProcedure(Recipe recipe) {
        String getCookingProcedure = "SELECT * FROM CookingProcedure WHERE is = " + recipe.getId() +
                " and type = 'r';";
        PersistenceManager.executeQuery(getCookingProcedure, new ResultHandler() {
            @Override
            public void handle(ResultSet rs) throws SQLException {
                cookingProcedures.add(0, CookingProcedure.loadProcedureById(rs.getInt("id")));
            }
        });
    }

    public int lastCookingProcedureAdded() {
        return cookingProcedures.get(0).getProcedure_id();
    }
    ...
    public void removeItem(MenuItem mi) {
        ...
        cookingProcedures.remove(CookingProcedure.loadProcedureByType(recipe.getId(), "r"));
    }
    ...
    public static void deleteMenu(Menu m) {
        ...
        String delProcedures = "DELETE FROM MenuProcedures WHERE menu_id = " + m.getId();
        PersistenceManager.executeUpdate(delProcedures);
    ...
    public static ObservableList<Menu> loadAllMenus() {
        ...
        for (int i = 0; i < newMenus.size(); i++) {
            ...
            //retrieve the CookingProcedure objects associated with the specified Menu object
            retrieveCookingProcedures(m);
        }
    ...
    private static void retrieveCookingProcedures(Menu menu) {
        menu.cookingProcedures.clear();
        String getCookingProcedures = "SELECT * FROM MenuProcedures WHERE menu_id = " + menu.getId() + ";";
        PersistenceManager.executeQuery(getCookingProcedures, new ResultHandler() {
            @Override
            public void handle(ResultSet rs) throws SQLException {
                menu.addCookingProcedure(CookingProcedure.loadProcedureById(rs.getInt("procedure_id")));
            }
        });
    }

    private void addCookingProcedure(CookingProcedure cookingProcedure) {
        cookingProcedures.add(0, cookingProcedure);
    }
    ...
    public List<CookingProcedure> getCookingProcedures() {
        List<CookingProcedure> menuProcedures = new ArrayList<>();
        for (CookingProcedure cookingProcedure : cookingProcedures)
            expandPreparationTree(menuProcedures, cookingProcedure);
        return menuProcedures;
    }

    public void expandPreparationTree(List<CookingProcedure> menuProcedure, CookingProcedure cookingProcedure) {
        menuProcedure.add(cookingProcedure);
        for (CookingPreparation cookingPreparation : cookingProcedure.getPreparations())
            expandPreparationTree(menuProcedure, cookingPreparation);
    }
